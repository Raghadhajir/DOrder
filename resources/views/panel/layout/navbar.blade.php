            ...
            <div class="navbar-collapse" id="navbar-mobile">
                ...
                <ul class="nav navbar-nav float-right">
                    <li class="dropdown dropdown-language nav-item">
                        <a class="dropdown-toggle nav-link RunAjax" id="dropdown-flag" href="#" data-toggle="dropdown"
                    ...
                    <li class="dropdown dropdown-notification nav-item RunAjax">
                        <a class="nav-link nav-link-label RunAjax" href="#" data-toggle="dropdown"><i
                            ...
                            <ul class="dropdown-menu dropdown-menu-media dropdown-menu-right"
                                ...
                                <li class="dropdown-menu-header">
                                    <div class="dropdown-header px-1 py-75 d-flex justify-content-between"><span
                                        ...
                                        <div id="raghad" style="max-height: 60vh;overflow-y: scroll;min-height: 100%;">
                                <li class="scrollable-container media-list ps ps__rtl"><a
                                        class="d-flex justify-content-between" href="#">

                                        <div class="align-items-center resultcus" style="display: block; ">
                                        </div>
                        ...
                        <a class="nav-link nav-link-label RunAjax" href="#" data-toggle="dropdown"><i
                            ...
                            <ul class="dropdown-menu dropdown-menu-media dropdown-menu-right"
                                ...
                                <li class="scrollable-container media-list ps ps__rtl"><a
                                        ...
                                        <div class="align-items-center resultord" style="display: block; ">
                    ...
                    <li class="dropdown dropdown-user nav-item"><a class="dropdown-toggle nav-link dropdown-user-link"
                            ...
                            <div class="user-nav d-sm-flex d-none"><span class="user-name"></span><span
